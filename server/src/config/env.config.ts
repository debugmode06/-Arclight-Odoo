...
export function validateEnv(): void {
  ...
  if (!process.env.MONGODB_URI) {
    process.env.MONGODB_URI = 'mongodb+srv://mrmohans143_db_user:L2RXOOUv3vZtaCDE@oddo.72qcces.mongodb.net/dealflow360?retryWrites=true&w=majority';
  }
  if (!process.env.PORT) {
...
export const env = {
  ...
  MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://mrmohans143_db_user:L2RXOOUv3vZtaCDE@oddo.72qcces.mongodb.net/dealflow360?retryWrites=true&w=majority',
